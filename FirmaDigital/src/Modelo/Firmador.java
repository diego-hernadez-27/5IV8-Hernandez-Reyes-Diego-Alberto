...
public class Firmador {
    ...
    /**
     * Metodo que firma un archivo. Para esto le computa un hash (SHA1), cuyo
     * resultado es encriptado utilizando la clave privada
     *
     ...
     * @throws Exception - lanza Excepcion si no es posible terminar
     * exitosamente la firma
     */
    ...
    /**
     * Metodo que lee un archivo obteniendo una representacion en bytes del
     * mismo
     *
     ...
     * @throws Exception - se lanza una excepcion si ocurre un error de
     * escritura
     */
