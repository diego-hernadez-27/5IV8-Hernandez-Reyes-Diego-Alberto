...
public class Verificador {
     ...
     *
     * @param rutaArchivo - ruta del archivo del cual se quiere verificar su
     * firma
     * @param rutaFirma - ruta de la firma digital del archivo
     * @param rutaClavePublica - ruta de la clave publica del firmador
     * @return boolean - True si la firma es correcta (veridica), False en caso
     * contrario
     * @throws Exception - lanza excepcion si no se termina la validacion
     * correctamente
     */
     ...
     * @return byte[] - retorno un arreglo de bytes que representa el contenido
     * del archivo
    ...
    /**
     * Metodo capaz de obtener la clave publica que esta almacenada en un
     * archivo
     *
