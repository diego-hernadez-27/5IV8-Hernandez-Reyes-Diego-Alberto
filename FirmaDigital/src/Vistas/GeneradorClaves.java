...
public class GeneradorClaves extends JFrame implements ActionListener {
    ...
    public GeneradorClaves(Inicio inicio) {
        ...
        JLabel labConfirmarContrasena = new JLabel("Repita la contraseña");
        ...
        JButton butExportarClavePublica = new JButton("Exportar la clave publica");
    ...
    public void generarClaves() {
        ...
        if (pass1.equals("") || pass2.equals("")) {
            ...
            if (pass1.equals(pass2) == false) {
                JOptionPane.showMessageDialog(this, "No coindice la contraseña", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
